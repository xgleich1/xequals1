...
object OutOfPositiveDashOperationToPositiveDashOperationMapper
    : ShiftingMapper<PositiveDashOperation, PositiveDashOperation> {

    override fun map(sourceSide: Term, targetSide: Term) =
            sourceSide as PositiveDashOperation and targetSide as PositiveDashOperation
}