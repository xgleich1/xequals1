...
class SingleSelectionNumeratorMultiplicationWithTargetLeftCalculatorTest {
    @Mock
    ...
    @Test
    fun `Should calculate a single selection numerator multiplication with the target on the left`() {
        // GIVEN
        ...
        whenever(singleSelectionNumeratorMultiplicationCalculator
                .calculate(link, singleTarget, singleSource))
