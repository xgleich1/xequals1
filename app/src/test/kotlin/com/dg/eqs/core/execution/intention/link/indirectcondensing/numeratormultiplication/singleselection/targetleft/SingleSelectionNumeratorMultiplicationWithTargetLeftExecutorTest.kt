...
class SingleSelectionNumeratorMultiplicationWithTargetLeftExecutorTest {
    @Mock
    private lateinit var detector: SingleSelectionNumeratorMultiplicationWithTargetLeftDetector
    @Mock
    private lateinit var calculator: SingleSelectionNumeratorMultiplicationWithTargetLeftCalculator
    @InjectMocks
    private lateinit var executor: SingleSelectionNumeratorMultiplicationWithTargetLeftExecutor
    ...
    @Test
    fun `Should report when the execution of a single selection numerator multiplication with the target on the left is invalid`() {
        // GIVEN
