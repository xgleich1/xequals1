...
class EndlessLevelGameStatusRepositoryTest {
    @InjectMocks
    private lateinit var repository: EndlessLevelGameStatusRepository
    ...
    @Test
    fun `Should load the initial status fitting for all level`() {
        // WHEN
