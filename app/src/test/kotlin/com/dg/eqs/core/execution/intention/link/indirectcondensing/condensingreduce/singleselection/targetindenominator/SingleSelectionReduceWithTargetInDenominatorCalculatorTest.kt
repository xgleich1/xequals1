...
class SingleSelectionReduceWithTargetInDenominatorCalculatorTest {
    @Mock
    private lateinit var singleSelectionReduceCalculator: SingleSelectionReduceCalculator
    @InjectMocks
    private lateinit var calculator: SingleSelectionReduceWithTargetInDenominatorCalculator
    ...
    @Test
    fun `Should calculate the result of a single selection reduce with the target in the denominator`() {
        // GIVEN
        ...
        whenever(singleSelectionReduceCalculator
                .calculate(origin, singleSource, singleTarget))
