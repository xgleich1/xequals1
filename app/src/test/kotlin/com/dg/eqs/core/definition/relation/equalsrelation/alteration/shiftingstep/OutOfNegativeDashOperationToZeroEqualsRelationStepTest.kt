...
class OutOfNegativeDashOperationToZeroEqualsRelationStepTest {
    @Test
    fun `A out of negative dash operation to zero equals relation step is applicable to a matching left to right shifting`() {
        // GIVEN
    ...
    @Test
    fun `A out of negative dash operation to zero equals relation step is applicable to a matching right to left shifting`() {
        // GIVEN
        val source = termsOf(PositiveValue(1))
    ...
    @Test
    fun `Should apply a out of negative dash operation to zero equals relation step to an applicable left to right shifting`() {
        // GIVEN
        val source = termsOf(PositiveValue(1))
    ...
    @Test
    fun `Should apply a out of negative dash operation to zero equals relation step to an applicable right to left shifting`() {
        // GIVEN
        val source = termsOf(PositiveValue(1))
    ...
    private fun isApplicable(equalsRelation: EqualsRelation, source: Terms, targetSide: Term) =
            OutOfNegativeDashOperationToZeroEqualsRelationStep.isApplicable(equalsRelation, source, targetSide)

    private fun apply(equalsRelation: EqualsRelation, source: Terms, targetSide: Term) =
            OutOfNegativeDashOperationToZeroEqualsRelationStep.apply(equalsRelation, source, targetSide)
}