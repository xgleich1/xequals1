...
class AdditionToAnythingIntegratorTest {
    @Test
    fun `Should integrate a single source by adding it to the target side`() {
        // GIVEN
    ...
    @Test
    fun `Should integrate multiple sources by adding them to the target side`() {
        // GIVEN
    ...
    private fun integrate(source: Terms, targetSide: Term) =
            AdditionToAnythingIntegrator.integrate(source, targetSide)
}