...
class SingleSelectionNumeratorMultiplicationWithSourceLeftDetectorTest {
    @Mock
    ...
    @Test
    fun `Should detect the event of a single selection numerator multiplication with the source on the left`() {
        // GIVEN
